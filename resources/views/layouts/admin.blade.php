        ...
        <nav :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 md:relative md:translate-x-0 bg-ink text-white w-64 h-full flex flex-col flex-shrink-0 shadow-2xl md:shadow-none transition-transform duration-300">
            ...
            <div class="overflow-y-auto no-scrollbar flex-1 px-4 py-6">
                ...
                <div class="space-y-1">
                    ...
                    @foreach($navMain as $item)
                        ...
                        <a href="{{ route($item['route']) }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ $isActive ? 'bg-gradient-to-r from-magenta to-bruce text-white shadow-glow font-bold' : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
                    ...
                    <div class="pt-6">
                        ...
                        <a href="{{ route('admin.configuracoes.index') }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.configuracoes.*') ? 'bg-gradient-to-r from-magenta to-bruce text-white shadow-glow font-bold' : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
            ...
            <div class="p-4 border-t border-white/10 flex-shrink-0 bg-inkLight/50">
                <div class="flex items-center gap-3 px-2 py-2 mb-2">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-magenta to-bruce flex items-center justify-center text-sm font-bold text-white shadow-md">
