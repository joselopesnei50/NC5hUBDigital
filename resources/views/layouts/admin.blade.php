            ...
            <div class="overflow-y-auto no-scrollbar flex-1 px-4 py-6">
                ...
                <div class="space-y-1">
                    ...
                    @foreach($navMain as $item)
                        ...
                        <a href="{{ route($item['route']) }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ $isActive ? 'bg-[#E63888] text-white shadow-md font-bold' : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
                    ...
                    <div class="pt-6">
                        ...
                        <a href="{{ route('admin.configuracoes.index') }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.configuracoes.*') ? 'bg-[#E63888] text-white shadow-md font-bold' : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
