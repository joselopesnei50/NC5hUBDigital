        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('customer.produtos.update', $produto->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="tipo" id="tipo" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="Serviço" {{ old('tipo', $produto->tipo) == 'Serviço' ? 'selected' : '' }}>Serviço</option>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="preco_padrao" id="preco_padrao" value="{{ old('preco_padrao', $produto->preco_padrao) }}" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <input type="text" list="unidades" name="unidade_medida" id="unidade_medida" value="{{ old('unidade_medida', $produto->unidade_medida) }}" placeholder="Ex: UN, KG, HR..." class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nome" id="nome" value="{{ old('nome', $produto->nome) }}" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="descricao" id="descricao" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('descricao', $produto->descricao) }}</textarea>
