...
@section('content')
    ...
    {{-- =====================================================
         CHAMADA · Marketing estratégico voltado a vendas
         ===================================================== --}}
    <section class="relative bg-[#050505] py-28 lg:py-40 border-t border-white/10" x-data="{ shown: false }" x-intersect.margin.-100px="shown = true">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="reveal" :class="shown ? 'active' : ''">
                <h2 class="font-display font-extrabold text-white leading-[1.02] tracking-tight
                           text-4xl md:text-6xl lg:text-[80px] mb-8 lg:mb-10">
                    Marketing estratégico.<br>
                    <span class="text-white/35">Vendas reais.</span>
                </h2>

                <p class="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl mx-auto">
                    Pequenas e médias empresas não precisam de mais likes — precisam de
                    <span class="text-white">faturamento previsível</span>. Reunimos posicionamento de marca, automação comercial e inteligência artificial em um único método pensado para quem vende no dia a dia.
                </p>
            </div>
        </div>
    </section>
