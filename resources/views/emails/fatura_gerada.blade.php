            ...
            <table role="presentation" width="560" cellspacing="0" cellpadding="0" border="0" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(10,17,40,0.06);">
                ...
                <tr>
                    <td style="background-color:#0A1128;padding:32px 40px;">
                        ...
                        <h1 style="margin:8px 0 0 0;font-size:26px;font-weight:800;color:#ffffff;line-height:1.2;">Fatura disponível.</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:36px 40px 24px 40px;">
                        <p style="margin:0 0 16px 0;font-size:16px;line-height:1.6;color:#0A1128;">
                            Olá, <strong>{{ $fatura->cliente->user->name ?? $fatura->cliente->razao_social }}</strong>.
                        </p>
                        <p style="margin:0 0 24px 0;font-size:15px;line-height:1.65;color:#3A3A3C;">
                            Uma fatura está disponível no seu painel de cliente da NC5 Hub.
                        </p>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#F4F5F7;border-radius:12px;margin:8px 0 28px 0;">
                            <tr>
                                <td style="padding:20px 24px;">
                                    <p style="margin:0 0 4px 0;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8A8F9C;">Descrição</p>
                                    <p style="margin:0 0 16px 0;font-size:15px;font-weight:600;color:#0A1128;">{{ $fatura->descricao }}</p>

                                    <p style="margin:0 0 4px 0;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8A8F9C;">Vencimento</p>
                                    <p style="margin:0 0 16px 0;font-size:15px;font-weight:600;color:#0A1128;">{{ \Carbon\Carbon::parse($fatura->vencimento)->format('d/m/Y') }}</p>

                                    <p style="margin:0 0 4px 0;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8A8F9C;">Valor</p>
                                    <p style="margin:0;font-size:24px;font-weight:800;color:#FF7A1A;">R$ {{ number_format($fatura->valor, 2, ',', '.') }}</p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td align="center" style="padding:8px 0 12px 0;">
                                    <a href="{{ route('customer.invoices.show', $fatura->id) }}"
                        ...
                        @if($fatura->link_pagamento)
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" style="padding:8px 0 12px 0;">
                                        <a href="{{ $fatura->link_pagamento }}"
                                           style="display:inline-block;background-color:#FF7A1A;color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;padding:14px 32px;border-radius:999px;">
                                            Pagar online (Link Direto)
                                        </a>
                                    </td>
                                </tr>
                            </table>
                ...
                <tr>
                    <td style="padding:24px 40px 32px 40px;border-top:1px solid #F0F1F3;">
                        <p style="margin:0;font-size:12px;color:#8A8F9C;line-height:1.6;">
                            NC5 Hub — Marketing, Design & Performance
                        </p>
                    </td>
                </tr>
            </table>
