...
<title>Atualização no seu material — NC5 Hub Digital</title>
</head>
            ...
            <table role="presentation" width="560" cellspacing="0" cellpadding="0" border="0" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(10,17,40,0.06);">
                ...
                <tr>
                    <td style="background-color:#0A1128;padding:32px 40px;">
                        ...
                        <h1 style="margin:8px 0 0 0;font-size:24px;font-weight:800;color:#ffffff;line-height:1.2;">A NC5 respondeu ao seu feedback</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:36px 40px 24px 40px;">
                        ...
                        <p style="margin:0 0 24px 0;font-size:15px;line-height:1.65;color:#3A3A3C;">
                            A equipe de produção respondeu às observações que você enviou sobre o material
                            <strong>{{ $material->titulo }}</strong>. Confira abaixo o retorno e finalize a aprovação no portal.
                        </p>
                        ...
                        <p style="margin:24px 0 0 0;font-size:13px;line-height:1.6;color:#8A8F9C;text-align:center;">
                            Se ainda houver ajustes a fazer, envie novas observações pelo portal.
                        </p>
                    </td>
                </tr>
